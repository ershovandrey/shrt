...
namespace Drupal\shorty\Plugin\Menu\LocalAction;
...
/**
 * Modifies the 'Add Shorty' local action to add a destination.
 */
class AddShortyLocalAction extends LocalActionDefault {
